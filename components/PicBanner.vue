      ...
      <div class="relative lg:-my-8">
        ...
        <div class="mx-auto max-w-md px-6 sm:max-w-3xl lg:h-full lg:p-0">
          <div class="aspect-w-10 aspect-h-6 overflow-hidden rounded-xl shadow-xl sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full">
            <img class="object-cover lg:h-full lg:w-full" :src="picture" alt="">
          </div>
        </div>
      </div>
        ...
        <div class="mx-auto max-w-md px-6 sm:max-w-2xl lg:max-w-none lg:px-0 lg:py-20">
          <blockquote>
            <div>
              ...
              <p class="mt-6 text-2xl font-medium text-white">I'm a passionate developer, designer and obsessive learner who loves to create eye catching software and daring interaction concepts.</p>
            </div>
            <!-- <footer class="mt-6">
...
export default {
    data() {
        return {
            picture: require('../assets/img/Pic.jpg')
        }
    }
}
</script>